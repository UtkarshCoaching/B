const questions = [
    {
        question: "ভারতের রাষ্ট্রপতি কার দ্বারা নিযুক্ত হন?",
        options: [
            "প্রধানমন্ত্রী",
            "নির্বাচক মণ্ডলী (Electoral College)",
            "লোকসভার স্পিকার",
            "ভারতের প্রধান বিচারপতি"
        ],
        answer: "নির্বাচক মণ্ডলী (Electoral College)",
        userAnswer: null, // To store user's selected answer
        status: null      // To store 'correct', 'wrong', 'skipped'
    },
    {
        question: "ভারতের প্রধানমন্ত্রী কার দ্বারা নিযুক্ত হন?",
        options: [
            "ভারতের প্রধান বিচারপতি",
            "উপ-রাষ্ট্রপতি",
            "ভারতের রাষ্ট্রপতি",
    ...
    {
        question: "সুপ্রিম কোর্টের বিচারপতিরা কার দ্বারা নিযুক্ত হন?",
        options: [
            "আইনমন্ত্রী",
            "সংসদ",
            "ভারতের প্রধান বিচারপতি",
    ...
    {
        question: "রাজ্যপাল কার দ্বারা নিযুক্ত হন?",
        options: [
    ...
    {
        question: "মুখ্যমন্ত্রী কার দ্বারা নিযুক্ত হন?",
        options: [
            "ভারতের রাষ্ট্রপতি",
            "রাজ্যপাল",
            "ভারতের প্রধান বিচারপতি",
    ...
    {
        question: "ভারতের অ্যাটর্নি জেনারেল কার দ্বারা নিযুক্ত হন?",
        options: [
            "আইনমন্ত্রী",
            "প্রধানমন্ত্রী",
            "ভারতের রাষ্ট্রপতি",
    ...
    {
        question: "কম্পট্রোলার অ্যান্ড অডিটর জেনারেল (CAG) কার দ্বারা নিযুক্ত হন?",
        options: [
            "প্রধানমন্ত্রী",
            "অর্থ মন্ত্রণালয়",
            "সংসদ",
    ...
    {
        question: "মুখ্য নির্বাচন কমিশনার (Chief Election Commissioner) কার দ্বারা নিযুক্ত হন?",
        options: [
            "প্রধানমন্ত্রী",
            "সংসদ",
            "ভারতের প্রধান বিচারপতি",
    ...
    {
        question: "ইউনিয়ন পাবলিক সার্ভিস কমিশনের (UPSC) চেয়ারম্যান কার দ্বারা নিযুক্ত হন?",
        options: [
            "কেন্দ্রীয় মন্ত্রী পরিষদ",
            "সংসদ",
            "ভারতের রাষ্ট্রপতি",
            "প্রধানমন্ত্রী"
        ],
    ...
    {
        question: "হাইকোর্টের বিচারপতিরা কার দ্বারা নিযুক্ত হন?",
        options: [
            "হাইকোর্টের প্রধান বিচারপতি",
            "রাজ্যের মুখ্যমন্ত্রী",
            "রাজ্যপাল",
            "ভারতের রাষ্ট্রপতি (ভারতের প্রধান বিচারপতি এবং সংশ্লিষ্ট রাজ্যের রাজ্যপালের সাথে পরামর্শ করে)"
        ],
        answer: "ভারতের রাষ্ট্রপতি (ভারতের প্রধান বিচারপতি এবং সংশ্লিষ্ট রাজ্যের রাজ্যপালের সাথে পরামর্শ করে)",
        userAnswer: null,
        status: null
    },
    {
        question: "ভারতের প্রধান বিচারপতি কার দ্বারা নিযুক্ত হন?",
        options: [
            "আইনমন্ত্রী",
            "সংসদ",
            "প্রধানমন্ত্রী",
    ...
    {
        question: "রাজ্য পাবলিক সার্ভিস কমিশনের (SPSC) চেয়ারম্যান ও সদস্যরা কার দ্বারা নিযুক্ত হন?",
        options: [
            "ভারতের রাষ্ট্রপতি",
            "রাজ্য বিধানসভা",
            "রাজ্যের মুখ্যমন্ত্রী",
    ...
    {
        question: "ভারতের অর্থ কমিশন (Finance Commission) এর চেয়ারম্যান ও সদস্যরা কার দ্বারা নিযুক্ত হন?",
        options: [
            "প্রধানমন্ত্রী",
            "অর্থমন্ত্রী",
            "ভারতের রাষ্ট্রপতি",
    ...
    {
        question: "ভারতের জাতীয় তফসিলি জাতি কমিশনের (National Commission for Scheduled Castes) চেয়ারম্যান কার দ্বারা নিযুক্ত হন?",
        options: [
            "সংসদ",
            "সমাজ কল্যাণ মন্ত্রী",
            "প্রধানমন্ত্রী",
    ...
    {
        question: "ভারতের জাতীয় তফসিলি উপজাতি কমিশনের (National Commission for Scheduled Tribes) চেয়ারম্যান কার দ্বারা নিযুক্ত হন?",
        options: [
            "লোকসভার স্পিকার",
    ...
    {
        question: "জাতীয় মানবাধিকার কমিশনের (National Human Rights Commission) চেয়ারম্যান কার দ্বারা নিযুক্ত হন?",
        options: [
            "সংসদ",
            "কেন্দ্রীয় স্বরাষ্ট্রমন্ত্রী",
            "ভারতের রাষ্ট্রপতি",
            "ভারতের প্রধান বিচারপতি (অবসরপ্রাপ্ত)"
        ],
        answer: "ভারতের রাষ্ট্রপতি",
        userAnswer: null,
        status: null
    ...
    {
        question: "রাজ্যের অ্যাডভোকেট জেনারেল কার দ্বারা নিযুক্ত হন?",
        options: [
            "রাজ্যের আইনমন্ত্রী",
            "মুখ্যমন্ত্রী",
            "রাজ্যপাল",
    ...
    {
        question: "ভারতের প্রধান তথ্য কমিশনার (Chief Information Commissioner) কার দ্বারা নিযুক্ত হন?",
        options: [
    ...
    {
        question: "কেন্দ্রীয় ভিজিল্যান্স কমিশনের (Central Vigilance Commission) প্রধান কার দ্বারা নিযুক্ত হন?",
        options: [
    ...
    {
        question: "ভারতের নির্বাচন কমিশনাররা (Election Commissioners) কার দ্বারা নিযুক্ত হন?",
        options: [
            "আইন মন্ত্রণালয়",
    ...
    {
        question: "রাজ্যের অ্যাডমিনিস্ট্রেটিভ ট্রাইব্যুনালের (State Administrative Tribunal) চেয়ারম্যান কার দ্বারা নিযুক্ত হন?",
        options: [
    ...
    {
        question: "ভারতের জাতীয় নারী কমিশনের (National Commission for Women) চেয়ারম্যান কার দ্বারা নিযুক্ত হন?",
        options: [
            "ভারতের প্রধান বিচারপতি",
            "মহিলা ও শিশু উন্নয়ন মন্ত্রী",
            "প্রধানমন্ত্রী",
            "কেন্দ্রীয় সরকার (রাষ্ট্রপতির নামে)"
        ],
        answer: "কেন্দ্রীয় সরকার (রাষ্ট্রপতির নামে)",
        userAnswer: null,
        status: null
    },
    {
        question: "ভারতের জাতীয় সংখ্যালঘু কমিশনের (National Commission for Minorities) চেয়ারম্যান কার দ্বারা নিযুক্ত হন?",
        options: [
            "লোকসভার স্পিকার",
            "প্রধানমন্ত্রী",
    ...
    {
        question: "কেন্দ্রীয় প্রশাসনিক ট্রাইব্যুনালের (Central Administrative Tribunal - CAT) চেয়ারম্যান কার দ্বারা নিযুক্ত হন?",
        options: [
            "কেন্দ্রীয় মন্ত্রী পরিষদ",
    ...
    {
        question: "রাজ্যের মহাধিবক্তা (Advocate General of State) কার দ্বারা নিযুক্ত হন?",
        options: [
            "রাজ্য আইনসভা",
            "হাইকোর্টের প্রধান বিচারপতি",
            "রাজ্যের মুখ্যমন্ত্রী",
